...
public class DisplayInventory : MonoBehaviour
{
    ...
    public int NUMBER_BETWEEN_COLUMN;
    ...
    {
        return new Vector3(X_START + (X_SPACE_BETWEEN_ITEM * (i % NUMBER_BETWEEN_COLUMN)), (Y_START + (-Y_SPACE_BETWEEN_ITEMS * (i / NUMBER_BETWEEN_COLUMN))), 0f);
    }
}
